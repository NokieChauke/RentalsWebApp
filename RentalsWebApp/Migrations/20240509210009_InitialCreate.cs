        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pic4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Pic5 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Pic6 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentPictureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Apartments_ApartmentPictures_ApartmentPictureId",
                        column: x => x.ApartmentPictureId,
                        principalTable: "ApartmentPictures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CardDescreption = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProofOfPayment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProofOfPayment_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProofOfPayment_Billings_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartments_ApartmentPictureId",
                table: "Apartments",
                column: "ApartmentPictureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProofOfPayment_BillId",
                table: "ProofOfPayment",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_ProofOfPayment_UserId",
                table: "ProofOfPayment",
                column: "UserId");
        }
