...
namespace RentalsWebApp.Migrations
{
    ...
    [Migration("20240509210009_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalsWebApp.Models.ApartmentPictures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalsWebApp.Models.Apartments", b =>
                {
                    ...
                    b.Property<int>("ApartmentPictureId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalsWebApp.Models.BankAccount", b =>
                {
                    ...
                    b.Property<int>("CardDescreption")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalsWebApp.Models.Notifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AccountChanges")
                        .HasColumnType("bit");

                    b.Property<bool>("Email")
                        .HasColumnType("bit");

                    b.Property<bool>("NewApartment")
                        .HasColumnType("bit");

                    b.Property<bool>("RentIncrease")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("StatementUpload")
                        .HasColumnType("bit");

                    b.Property<bool>("TermsNConditions")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RentalsWebApp.Models.ProofOfPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalsWebApp.ViewModels.SendMailViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentalsWebApp.Models.Apartments", b =>
                {
                    ...
                    b.HasOne("RentalsWebApp.Models.ApartmentPictures", "ApartmentPictures")
                        .WithMany()
                        .HasForeignKey("ApartmentPictureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RentalsWebApp.Models.ProofOfPayment", b =>
                {
                    b.HasOne("RentalsWebApp.Models.Billing", "Billing")
                        .WithMany()
